                    ...
                    <div class="user">
                        ...
                        <div class="user__info">
                            ...
                            <div class="user__info__status">
                                {!! $prs->total_count >= 4 ? '<span class="complete">✔</span>' : '<span class="incomplete">✘</span>' !!} {{ $prs->total_count }} / 4 pull requests (2019 edition) done
                            </div>
                        </div>
                    </div>
                ...
                @else
                    @if (!$sharingMode)
                        ...
                        @elseif ($prs->total_count == 2)
                            <h2 class="mb-0 centered">You're halfway there, keep doing!</h2>
                        @elseif ($prs->total_count == 3)
                            <h2 class="mb-0 centered">Only 1 left, let's keep doing.</h2>
                        @endif
