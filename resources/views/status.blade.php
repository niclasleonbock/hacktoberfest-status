    ...
    <div class="container container--header">
        <div class="container__content centered">
            ...
            <p class="mb-30 mt-30 description">
                @if ($sharingMode)
                These are the <a href="https://hacktoberfest.digitalocean.com/">Hacktoberfest</a> stats of {{
                $user->name }}.
                @else
                This little tool helps you to track your <a
                        href="https://hacktoberfest.digitalocean.com/">Hacktoberfest</a> status. Below you can see how
            ...
            <div class="user">
                ...
                <div class="user__info">
                    <h4 id="user__info__name"><a href="https://github.com/{{ $user->github_username }}">{{ $user->name
                            }}</a></h4>

                    <div class="user__info__status">
                        {!! $prs->total_count >= 4 ? '<span class="complete">✔</span>' : '<span
                                class="incomplete">✘</span>' !!} {{ $prs->total_count }} / 4 pull requests done
                    </div>
                </div>
            </div>
            ...
            <div class="share mt-10">
                ...
                <div class="fb-share-button"
                     data-href="{{ route('share', ['github_username' => $user->github_username]) }}"
                     data-layout="button" data-size="small" data-mobile-iframe="true"></div>
            </div>
...
<main>
    <div class="container content">
        ...
        <div class="centered">
            ...
            <p class="description">
                Why don't you get yourself some inspiration on the <a href="https://hacktoberfest.digitalocean.com/">Hacktoberfest
                    website</a>?
            </p>
            @endif
        </div>
            ...
            <ul class="summary__list">
                ...
                <li class="summary__box">
                    <div class="summary__box__header">
                        <h3>
                            <a href="{{ $item->html_url }}" class="tooltip" data-title="{{ $item->title }}">{{
                                str_limit($item->title, 32) }}</a>
                        </h3>
                    </div>
                    <p class="summary__box__meta">
                        Created in <a href="{{ $item->repo->html_url }}" class="tooltip"
                                      data-title="{{ $item->repo->full_name }}">{{ $item->repo->name }}</a> {{
...
<footer class="footer">
    <hr>
    <div class="container">
        <p>This site is in no way affiliated with DigitalOcean, GitHub or the Hacktoberfest project. But it participates
            in the Hacktoberfest. So why not <a href="https://github.com/niclasleonbock/hacktoberfest-status">contribute
                on GitHub</a>?</p>
    </div>
</footer>
